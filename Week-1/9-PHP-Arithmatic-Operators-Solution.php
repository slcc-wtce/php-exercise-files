...
<body>
	...
	3. Create an echo statement that sends a line break to the screen*/
    $z = $x + $y;
    echo "$x + $y = $z";
    echo "<br>";
    ...
    /*1. Create a variables that calculates the modulus (remainder) the earlier two
	2. Echo the variable to the screen
	3. Create an echo statement that sends a line break to the screen*/
    $z = $x % $y;
    echo "$x % $y = $z";
    ...
    /*1. Create a variables that calculates the first to the power of the second.
	2. Echo the variable to the screen
	3. Create an echo statement that sends a line break to the screen*/
    $z = $x ** $y;
    echo "$x ** $y = $z";
